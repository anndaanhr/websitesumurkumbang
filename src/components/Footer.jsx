  ...
  return (
    <footer className="mt-32 py-10 md:py-12 border-t border-white/10 glass-panel relative z-10">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        <div className="text-center md:text-left text-white/50 text-xs md:text-sm order-2 md:order-1 space-y-1">
          ...
          <p>
            <a 
              ...
              className="text-white/60 hover:text-accent transition-colors inline-flex items-center gap-1 font-sans text-xs"
            >
              <span>Instagram Resmi: <span className="font-semibold text-white/80 hover:text-accent">@sumurkumbangofficial</span></span>
              <span>↗</span>
            </a>
          </p>
        </div>
